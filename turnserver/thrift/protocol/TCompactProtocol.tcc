...
uint32_t TCompactProtocolT<Transport_>::writeDouble(const double dub) {
  static_assert(sizeof(double) == sizeof(uint64_t), "double requires 64-bit");
  static_assert(std::numeric_limits<double>::is_iec559, "double requires iec559");
