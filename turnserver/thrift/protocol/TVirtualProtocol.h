...
class TProtocolDefaults : public TProtocol {
 public:
  uint32_t readMessageBegin(std::string& name,
	...
	throw TProtocolException(TProtocolException::NOT_IMPLEMENTED, "this protocol does not support reading (yet).");
#endif
	assert(0);
  }
  ...
  uint32_t writeMessageBegin(const std::string& name,
    ...
    (void) seqid;
#if AGORARTC_HAS_EXCEPTION
	throw TProtocolException(TProtocolException::NOT_IMPLEMENTED, "this protocol does not support writing (yet).");
#endif
	assert(0);
  }
